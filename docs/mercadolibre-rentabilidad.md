...
13. Toda la persistencia local de una importación se confirma en una única transacción; si falla la orden, sus ítems, costos, pago o vínculo, se revierte el conjunto completo y solo queda el log de error.
